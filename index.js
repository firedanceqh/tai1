...
mongoose.connect('mongodb+srv://tai:12345@cluster0.8xvrp.mongodb.net/tai?retryWrites=true&w=majority', {useNewUrlParser: true, useUnifiedTopology: true}, function(err){
    if (err){
...
app.get("/report", controllerMid.aulogin, controller.report)

app.get("/", controllerUser.home);
app.get("/nam", controllerUser.quannam);
app.get("/nu", controllerUser.aonam);
